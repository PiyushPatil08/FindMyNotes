    ...
    <div className="min-h-[80vh] flex items-center justify-center bg-gray-50 py-8 px-2">
      <form className="w-full max-w-md flex flex-col gap-4 rounded-xl bg-white p-8 shadow-xl" onSubmit={registerUser}>
        ...
        <div className="flex w-full flex-col items-center justify-center">
          <div className="mb-4 grid h-[120px] w-[120px] place-content-center overflow-hidden rounded-full border-2 border-dashed border-gray-300 bg-gray-50 text-2xl font-black">
            {profilePreviewImage === "" ? (
              <p className="text-sm font-bold text-gray-500">Profile Image</p>
            ) : (
              <img src={profilePreviewImage} alt="" className="object-cover w-full h-full" />
            )}
          </div>
          <label
        ...
        <button className="rounded-lg bg-blue-500 px-5 py-2 font-bold text-white hover:bg-blue-600 mt-2">
          Register
        </button>
